...
export default function SuperAdminLoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        sessionStorage.setItem("superadmin_auth", result.token)
    ...
    <div className="min-h-screen bg-black text-white flex items-center justify-center p-8">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-pink-500 mb-2">SUPER POKER</h1>
        ...
        <Card className="bg-gray-900 border-pink-500">
          <CardHeader>
            ...
            <CardDescription className="text-gray-400">
              Access the superadmin panel to manage invite codes
            </CardDescription>
          </CardHeader>
          <CardContent>
